...
const faqs = [
  {
    q: "How can it be 0 gas?",
    a: "We use Account Abstraction (ERC-4337) where our bundler fleet pays the gas fee on your behalf. For our Free plan, we partner with protocols to sponsor these fees.",
  },
  {
    q: "Is it non-custodial?",
    a: "Absolutely. Coin Fi never has access to your keys. Your funds are secured by smart contracts and device-level biometrics (Passkeys).",
  },
  {
    q: "Which chains are supported?",
    a: "We currently support Ethereum Mainnet, Polygon, Arbitrum, Optimism, Base, and Avalanche, with more being added weekly.",
  },
  {
    q: "What happens if I lose my phone?",
    a: "Coin Fi supports social recovery and multi-device sync. You can authorize a new device using your recovery partners or secondary devices.",
  },
];
      ...
      >
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground font-medium text-lg">
            Choose the plan that fits your journey into web3.
          </p>
        </div>
              ...
              <Button
                className={cn(
                  ...
                  plan.popular
                    ...
                    : "bg-transparent border border-zinc-800 hover:bg-zinc-800/50 hover:border-zinc-700 text-white",
                )}
                asChild
              >
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          {faqs.map((faq, i) => (
            <AccordionItem
              key={faq.q}
              value={`item-${i}`}
              className="border-none bg-zinc-900/20 rounded-3xl px-6 transition-all hover:bg-zinc-900/40 ring-1 ring-white/5"
            >
