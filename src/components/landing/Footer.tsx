        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1 space-y-6">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed">
              Making web3 accessible to everyone through gasless transactions and hardware-grade security.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-3">
              <p className="text-xs text-zinc-400 font-medium uppercase tracking-wider">Contact Sales</p>
              <p className="text-sm text-zinc-300">Need custom sponsorship for your dApp?</p>
              <a href="mailto:sales@coinfi.io" className="text-sm text-primary font-bold hover:underline">Get in touch →</a>
            </div>
          </div>
        </div>
